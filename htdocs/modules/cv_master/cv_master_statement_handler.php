...
//do we want all real remittances?
$real_remittances = array();
$real_remittances = Cash_Receipts::getall_real_remittances_of_customer_between_dates($cv_id, $startdate, $enddate);
...
require_once("cv_master_statement_summary.css");
...
switch($statementtype)
{
    ...
    case "simplified_outstanding":
        require_once("cv_master_statement_simplifiedoutstanding.phtml");
    break;
    case "itemized_outstanding":
        require_once("cv_master_statement_itemizedoutstanding.phtml");
    break;
    case "itemized_outstanding2":
        require_once("cv_master_statement_itemizedoutstanding2.phtml");
    break;
    case "scheduleE":
        require_once("cv_master_statement_scheduleE.phtml");
    break;
    default:
        require_once("cv_master_statement_summary.phtml");
    break;
