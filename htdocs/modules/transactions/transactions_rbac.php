...
$actions[] = "access_account";
$actions[] = "view_accounttree";
$actions[] = "configure_accounts";
$actions[] = "configure_module";
$actions[] = "create_account";
$actions[] = "reconcile_accounts";
$actions[] = "view_details";
$actions[] = "view_transactions";
$actions[] = "override_transactions";


$objects = array();
$objects[] = "transactions_module";
$objects[] = "all_transactions";
...
--
-- Table structure for table `transactions_accounts_mtm_users`
--
...
--
-- Table structure for table `transactions_accounttype`
--
...
--
-- Table structure for table `transactions_main`
--
...
if($ACTION == "LOAD DEFAULTS")
{
    ...
    $transaction->add_accountnew("NULL", "ASSETS", 0, 1, "", "Y");
    $transaction->add_accountnew("NULL", "ACCTS RECEIVABLE", 1, 1, "", "Y");
    $transaction->add_accountnew("NULL", "CASH", 1, 1, "", "Y");
    $transaction->add_accountnew("NULL", "LIABILITIES", 0, 2, "", "Y");
    $transaction->add_accountnew("NULL", "EQUITY", 0, 3, "",  "Y");
    $transaction->add_accountnew("NULL", "INCOME", 0, 4, "",  "Y");
    $transaction->add_accountnew("NULL", "EXPENSES", 0, 5, "",  "Y");
