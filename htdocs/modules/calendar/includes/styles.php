...
/* SECTION A */
?>body {
  color: <?php echo $calendar_config->TEXTCOLOR; ?>;
  font-family: <?php echo $calendar_config->getFonts(); ?>;
  font-size: 12px;
  background-color: <?php echo $calendar_config->BGCOLOR; ?>;
}
...
#trailer form {
  float: left;
  width: 25%;
  border-top: 1px solid <?php echo $calendar_config->TABLEBG; ?>;
  padding-top: 5px;
  margin-top: 5px;
  margin-bottom: 25px;
}
...
.dailymatrix {
  ...
  text-decoration: none;
  text-align: right;
  background-color: <?php echo $calendar_config->THBG; ?>;
}
td.matrixappts {
  cursor: pointer;
  text-align: left;
  background-color: <?php echo $calendar_config->CELLBG; ?>;
...
.matrixd {
  border-left: 1px solid <?php echo $calendar_config->TABLEBG; ?>;
  border-right: 1px solid <?php echo $calendar_config->TABLEBG; ?>;
  margin-left: auto; 
  margin-right: auto;
}
.matrixlegend {
...
.popup {
  font-size: 12px;
  color: <?php echo $calendar_config->POPUP_FG; ?>;
  text-decoration: none;
  position: absolute;
  z-index: 20;
  visibility: hidden;
  top: 0px;
  left: 0px;
  border: 1px solid <?php echo $calendar_config->POPUP_FG; ?>;
  padding: 3px;
}
.popup dl {
  margin: 0px;
...
h2 {
  font-size: 20px;
  color: <?php echo $calendar_config->H2COLOR; ?>;
}
h3 {
  font-size: 18px;
}
...
?>.standard {
  border: 1px solid <?php echo $calendar_config->TABLEBG; ?>;
  background-color: <?php echo $calendar_config->CELLBG; ?>;
  font-size: 12px;
}
.standard th {
  color: <?php echo $calendar_config->THFG; ?>;
  font-size: 18px;
  padding: 0px;
  border-bottom: 1px solid <?php echo $calendar_config->TABLEBG; ?>;
}
...
.minical td {
  padding: 0px 2px;
  border: 1px solid <?php echo $calendar_config->BGCOLOR; ?>;
}
.minical td a {
  display: block;
  text-align: center;
...
.minical td.weekend {
  background-color: <?php echo $calendar_config->WEEKENDBG; ?>;
}
.minical td#today {
  background-color: <?php echo $calendar_config->TODAYCELLBG; ?>;
}
...
#day .minical td.selectedday {
  border: 2px solid <?php echo $calendar_config->TABLEBG; ?>;
}
#day .monthnav th {
  text-align: center;
  color: <?php echo $calendar_config->THFG; ?>;
...
.glance th.empty {
  border-top: 1px solid <?php echo $calendar_config->BGCOLOR; ?>;
  border-left: 1px solid <?php echo $calendar_config->BGCOLOR; ?>;
  background-color: <?php echo $calendar_config->BGCOLOR; ?>;
}
.glance th.row {
  border-top: 1px solid <?php echo $calendar_config->TABLEBG; ?>;
